...
class CronometroApp:
    def __init__(self, root):
        ...
        # UI
        self.titulo = tk.Label(self.root, text="Cronómetro", bg="#007BFF", fg="white", font=("Arial", 14), width=20)
        self.titulo.pack(fill=tk.X)

        self.crono_label = tk.Label(self.root, text="00:00:00:000", font=("Arial", 20))
        self.crono_label.pack(pady=10)

        self.start_button = tk.Button(self.root, text="Empezar", command=self.empezar_detener, width=20)
        self.start_button.pack(pady=5)

        self.intervalo_label = tk.Label(self.root, text="Intervalo (segundos):")
        ...
        self.config_button = tk.Button(self.root, text="Configurar Intervalo", command=self.verificar_contrasena, width=20)
        ...
        self.tiempo_total_label.pack(pady=5)
    ...
    def verificar_contrasena(self):
        ...
        self.contrasena_ventana.geometry("250x150")
